...
| ~~**H2 connection pool for staging**~~ | dag-executor §9, staging §9 | Shipped by [#118](https://github.com/msabiransari/datapipelines/issues/118): a bounded per-execution pool, `datapipelines.staging.h2.max-connections` (default 4). GitHub is the status authority. |
