...
| [auth.md](auth.md) | v2.2 | Generic OIDC login, internal JWT, API keys, **the scope↔operation matrix (§7.6)**, Spring Security chain |
...
| [datasources.md](datasources.md) | v1.1 | Named connections, 7 dialects, Hikari/JDBC property passthrough, AES-GCM credential storage |
| [staging.md](staging.md) | v1.2 frozen | Per-execution in-memory H2: lifecycle, identifier safety, single mutex-guarded connection, memory limits |
