...
| [scheduler.md](scheduler.md) | v1.0 | Schedules (#9): five-field cron in an IANA zone with a stated DST rule, missed/overlap policy, run states and what blocks, the system identity schedules fire under, per-instance capacity, one dispatcher across instances. Contributor doc — not packaged into the product yet |
