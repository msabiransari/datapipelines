...
| 2026-08-15 | v1.2 | V2 migration | §4.10 `datasources` gains `introspection_include_schemas JSONB NOT NULL DEFAULT '[]'` (migration V2) — the §7A introspection allowlist of datasources.md §3.3; `[]` and absent are the same behavior. |
