...
8. **Validate-on-write, universally.** Nothing invalid ever reaches the database — pipelines, templates, datasources, every saved contract validates fully at create/update time. The executor never receives an invalid pipeline. (This principle is cross-cutting: [Templates §7](templates.md#7-validation), [Datasources §9](datasources.md#9-validation-rules) apply it to their own entities.)
...
Defined and described in [Templates §7](templates.md#7-validation).
