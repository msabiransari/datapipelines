...
| `template.read` | Read templates, their versions and runs; the template pages, the editor's source. REST/UI: `GET /api/v1/templates`, `GET /api/v1/templates/versions`, `GET /partials/templates`, `GET /partials/templates/editor/source`, `GET /partials/templates/runs`, `GET /partials/templates/transform-face`, `GET /partials/templates/versions`, `GET /templates`, `GET /templates/editor`. MCP: `templates_list`, `templates_get`, `templates_used_by` | ✓ | ✓ | lens | ✓ | ✓ | ✗ | ✗ |
...
| `template.update` | Write a template's draft (the editor's Edit; the transform face's Save draft, 7d). REST/UI: `PUT /api/v1/templates`, `POST /partials/templates/editor/edit`, `POST /partials/templates/transform-face/save`. MCP: `templates_update` | ✗ | ✓ | ✗ | ✓ | ✓ | ✗ | ✗ |
