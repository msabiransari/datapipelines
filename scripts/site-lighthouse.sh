...
#   /  /how-it-works  /demo-data  /faq  /tableau  /published-api  /for/saas-teams
# (115 §C added /how-it-works; 116 added /demo-data.)
#
...
# Born 111 §C. Baseline: five pages, four categories, all >= 95. 115 added /how-it-works; 116 added /demo-data.
...
PAGES=("/" "/how-it-works/" "/demo-data/" "/faq/" "/tableau/" "/published-api/" "/for/saas-teams/")
...
echo "site-lighthouse: OK — seven pages, four categories, all >= $FLOOR"
