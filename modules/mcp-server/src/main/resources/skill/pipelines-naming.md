...
area: pipelines
layer: reference
purpose: Choosing where a new pipeline or template lives, or explaining the folder rules to a human.
---
...
- **Not permissions.** The workspace is the isolation boundary, and your ROLE in it is what
  you may do there — see `core-error-codes` for `auth.role_required`.
