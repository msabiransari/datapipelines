...
area: executions
layer: guide
purpose: Runs — execute, read and page results, cancel, and diagnose a failure.
---
...
a terminal state or the execution timeout (default ${execution_timeout_seconds} s) aborts it.
