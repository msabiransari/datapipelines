...
class McpServerWiringTest {
    ...
    /**
     * The §6.1 surface and the auth §7.6 matrix are the same 37 names, in both directions. A tool
     ...
     * `datasources_create`; 30 → 34 with 107's probe/cancel/purge four; 34 → 37 with 118's
     * `semantics_*` three.)
     */
    @Test
    fun `the tool surface is exactly the 37 tools the scope matrix knows`() {
    ...
    @Test
    fun `the server builds with all 37 tools and all three prompts registered`() {
