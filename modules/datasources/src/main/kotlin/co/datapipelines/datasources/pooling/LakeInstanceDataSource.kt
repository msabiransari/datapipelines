 ...
 * there is nothing to apply them to — a duplicate joins an instance, it does not log in. The
 * `CommonDataSource` plumbing is the minimal honest surface for a wrapper that owns no log
 * writer and no login timeout.
 */
