...
class ExecutionRepository(
    ...
    /**
     * Stamps `heartbeat_at` for a running execution (108 §D, V20).
     *
     ...
     *
     * `heartbeat_at` (V20) is stamped every `heartbeat-seconds` by the instance that owns the row,
     ...
     *
     * The age condition stays, restricted to rows with NO stamp. A pre-V20 instance never writes
