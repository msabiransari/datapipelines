...
object PublicPaths {
    ...
    val ENTRIES: List<PublicPath> =
        listOf(
            ...
            // Site v2 (2026-09-09): the intent pages — FAQ, roadmap, security, the published-API
            // page, the tool list, the Tableau hub and its how-to. Same shape, same reasoning.
            PublicPath("/faq", "Site v2 intent page: GET-only constant content, no datastore and no principal on the request.", "site-v2"),
            PublicPath(
                "/roadmap",
            ...
            // 119: the pricing page — "free and open source", stated where buyers look for it.
            PublicPath(
                "/pricing",
                "Site v2 intent page: GET-only constant content, no datastore and no principal on the request.",
                "119",
