 ...
 * [RepoFiles.MIGRATION_PATHS] — the same derived-list-over-plain-JDBC mechanism every
 * suite used to apply per class (module-structure §3.1 rule 2: no domain module takes the Flyway
...
internal object SharedPostgres {
    ...
    private const val DATABASE = "datapipelines_auth"
    ...
    private fun boot(container: PostgreSQLContainer<*>) {
        ...
        RepoFiles.MIGRATION_PATHS.forEach { path -> jdbc.execute(RepoFiles.read(path)) }
    }
