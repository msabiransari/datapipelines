...
internal object ConfigSnapshots {
    ...
    fun valid() =
        ConfigSnapshot(
            ...
            orgWeekStart = "monday",
            orgTimezone = "UTC",
            transformEvaluateTimeoutSeconds = 10,
            transformSuiteTimeoutSeconds = 60,
            transformAbandonGraceSeconds = 30,
            transformPoolSize = 4,
            transformPoolQueue = 64,
            transformMaxInputRows = 100_000,
            transformMaxValueBytes = 1_048_576,
            transformMaxStringBytes = 1_048_576,
            transformMaxDepth = 100,
