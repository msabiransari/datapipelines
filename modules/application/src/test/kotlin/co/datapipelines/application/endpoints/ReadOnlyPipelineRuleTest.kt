...
class ReadOnlyPipelineRuleTest {
    ...
    fun `the allowed set is the single constant the design promises`() {
        // The whole point of READ_ONLY_NODE_TYPES: admitting CALCULATOR when 072 lands is one
        // line here, not a hunt through branches.
        ReadOnlyPipelineRule.READ_ONLY_NODE_TYPES shouldBe setOf(NodeType.DQL, NodeType.PIPELINE)
    }
